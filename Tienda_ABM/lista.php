                ...
                <div class="col mb-5 ">
                    <div class="card h-100 w-80 shadow p-3 mb-5 bg-body rounded">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="https://mpago.la/2S5h6yP" class="btn btn-primary" target='_blank'>Comprar</a>
                            <a href="producto.php?id=<?php echo $reg['id'];?>" target='_blank' class="mt-2 btn btn-outline-success">Ver Producto</a>
                        </div>
                    </div>
                </div>
                <?php }?>
